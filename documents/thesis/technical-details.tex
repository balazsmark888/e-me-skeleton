...
software framework unifies a wide variety of frameworks that .NET has to offer including Windows Forms, ASP.NET Core etc.
...
layer. With the \emph{Development-time IIS support} feature, the web server allows \emph{hot reloading}, which speeds up the development/debugging
process.

The main building block of the backend is the ASP.NET Core web framework.
