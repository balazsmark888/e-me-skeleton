...
namespace e_me.Model.DBContext
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void AddUniqueIndexes(this ModelBuilder modelBuilder)
        {
            ...
            {
                e.HasIndex(p => p.DocumentTypeId).IsUnique();
            });

            modelBuilder.Entity<UserDetail>(e =>
            {
                e.HasIndex(p => p.PersonalNumericCode).IsUnique();
            ...
            modelBuilder.Entity<User>(e =>
            {
                ...
                e.HasIndex(p => p.LoginName).IsUnique();
            });

            modelBuilder.Entity<OneTimeAccessToken>(e =>
            {
                e.HasIndex(p => p.UserDocumentId).IsUnique();
            });
        }
