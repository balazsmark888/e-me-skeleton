...
namespace e_me.Model.Migrations
{
    ...
    [Migration("20210420140301_AddNewDocumentType")]
    partial class AddNewDocumentType
    {
            ...
            modelBuilder.Entity("e_me.Model.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9cfd64bd-3f8c-4ce9-b8da-552267897ac0"),
                            DisplayName = "Test Document Type",
                            Name = "TestDocumentType"
                        },
                        new
                        {
                            Id = new Guid("11f61509-08fd-4591-8ce8-5d009e69964d"),
            ...
            modelBuilder.Entity("e_me.Model.Models.SecurityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd640a09-4bff-4174-b298-083be91775bd"),
                            Name = "Administrator",
                            SecurityType = 0
                        },
                        new
                        {
                            Id = new Guid("7d7c04b2-fc0a-4195-8037-b31f35213958"),
                            Name = "Regular User",
                            SecurityType = 1
                        });
                });
