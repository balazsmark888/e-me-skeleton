...
namespace e_me.Model.Migrations
{
    ...
    [Migration("20210426183026_UpdateUserDetail")]
            ...
            modelBuilder.Entity("e_me.Model.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7b5a2ed8-c485-4a06-a03c-b884076769d3"),
                            DisplayName = "Test Document Type",
                            Name = "TestDocumentType"
                        },
                        new
                        {
                            Id = new Guid("5b356ef6-8c5e-4da7-82a2-bab693b944b9"),
            ...
            modelBuilder.Entity("e_me.Model.Models.SecurityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("448d96cb-6e63-410a-bf09-12091bde1eaf"),
                            Name = "Administrator",
                            SecurityType = 0
                        },
                        new
                        {
                            Id = new Guid("45eb8952-331f-4660-a5b5-1b41965538c5"),
                            Name = "Regular User",
                            SecurityType = 1
                        });
                });
